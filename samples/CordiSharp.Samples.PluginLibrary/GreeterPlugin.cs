...
/// <summary>A plugin in the library that injects the library's greeter service. The
/// <c>ctx.Greeter</c> accessor is GENERATED by the import source generator (same-assembly
/// <c>[Inject]</c> → direct typed accessor, no interface/bridge needed).</summary>
[Inject("greeter")]
public sealed class DependentPlugin : IPlugin<DependentConfig>
{
    public void Load(Context ctx, DependentConfig config)
    {
        var greeter = ctx.Greeter;
